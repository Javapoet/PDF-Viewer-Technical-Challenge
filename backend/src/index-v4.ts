...
import pdfRouter, { initPdfInfo } from './routes/pdf-v4.js';
...
console.log('index-v4.ts: REQUEST_TIMEOUT_MS = ', REQUEST_TIMEOUT_MS);
...
console.log('index-v4.ts: pdfBuildDir = ', pdfBuildDir);
